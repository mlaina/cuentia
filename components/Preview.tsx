...
export default function Component ({ pages = [], stream = false, hiddenPageText }: StoryViewerProps) {
  ...
  const renderLockedOverlay = (onlyBlur = false) => (
        ...
        <div className='relative'>
          ...
          >
              ...
              {pages[0].imageUrl
                ...
                : (
                  <div className='relative border-glow-container rounded-sm max-w-full max-h-full overflow-hidden shadow-inner shadow-md'>
                    <img alt='cover' src='https://imagedelivery.net/bd-REhjuVN4XS2LBK3J8gg/fd4aec4f-c805-43d7-ad00-4c7bde9f6c00/public' className='w-full h-full object-cover ' />
            ...
            {pages.slice(1, -1).flatMap((page, index) => [
              <div key={`text-${index * 2}`} className='page bg-white shadow-md rounded-md md:rounded-none relative'>
                {index > 0 && renderLockedOverlay()}
              ...
              <div key={`image-${index * 2 + 1}`} className='page bg-white shadow-md relative'>
                {index > 0 && renderLockedOverlay(true)}
