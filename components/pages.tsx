    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-amber-50">
            <div className="relative w-[800px] h-[500px] bg-white shadow-2xl rounded-r-lg overflow-hidden">
                <div className="absolute left-0 top-0 w-full h-full bg-[url('/paper-texture.png')] opacity-20 pointer-events-none"></div>
                ...
                <div className="absolute left-0 top-0 w-12 h-full bg-amber-200 rounded-r-lg shadow-inner"></div>
