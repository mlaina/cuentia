...
export default function StoryViewer({ pages = [], stream }: StoryViewerProps) {
          ...
          <div className="flex p-8 gap-8 min-h-[60vh]">
            ...
            <div className="w-1/2">
              {pages[currentPage].imageUrl ? (
                  ...
                  <div className="animate-pulse bg-gray-300 w-[500px] h-[500px] rounded-lg flex items-center justify-center" />
              )}
            </div>
          </div>
